...
var options = {
  port: 1883,
  host: 'matichouse.ml',
  clientId: 'matic_server_' + Math.round(Math.random() * (0- 10000) * -1) ,
  username: 'web_client',
  password: '121212',
  keepalive: 60,
...
var client = mqtt.connect("mqtt://matichouse.ml", options);
...
client.on('message', function (topic, message) {
  ...
  if (topic == "values"){
    ...
    var query = "INSERT INTO `admin_database`.`data` (`data_temp1`, `data_temp2`, `data_volts`) VALUES (" + temp1 + ", " + temp2 + ", " + volts + ");";
