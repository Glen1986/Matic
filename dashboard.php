...
$conn = mysqli_connect("localhost","admin_database","Yomismo86","admin_database");
...
<head>
  ...
  <meta name="apple-mobile-web-app-title" content="MaticHouse">
          ...
          <div class="nav-fold">
            <a href="profile.html">
              ...
              <span class="clear hidden-folded p-x">
                <span class="block _500">Nombre</span>
      ...
      <div class="app-footer">
        <div class="p-2 text-xs">
          <div class="pull-right text-muted py-1">
            &copy; Copyright <strong>MaticHouse</strong> <span class="hidden-xs-down">- Built with Love v1.1.3</span>
            ...
            <div class="col-xs-6 col-sm-4">
              <div class="box p-a">
                ...
                <div class="clear">
                  ...
                  <small class="text-muted">Temp Pic: 70 C</small>
                </div>
              </div>
            </div>
            <div class="col-xs-6 col-sm-4">
              <div class="box p-a">
                ...
                <div class="clear">
                  ...
                  <small class="text-muted">Tensión Pic: 5.8 V</small>
                </div>
              </div>
            </div>
          </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <label class="ui-switch ui-switch-md info m-t-xs">
                       <input id="input_led1" onchange="process_led(this)" type="checkbox" >
                       <i></i>
                    </label>
                  </div>
                </div>
              ...
              <div class="col-xs-12 col-sm-6">
                <div class="box p-a">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <label class="ui-switch ui-switch-md info m-t-xs">
                         <input id="input_led2" onchange="process_led(this)" type="checkbox" >
                        <i></i>
                      </label>
                    </div>
                  </div>
    ...
    <div id="switcher">
      <div class="switcher box-color dark-white text-color" id="sw-theme">
        ...
        <div class="box-header">
          <a href="https://themeforest.net/item/MaticHouse-app-ui-kit/13231484?ref=flatfull" class="btn btn-xs rounded danger pull-right">BUY</a>
...
//$("#ie.id").html("onchange")
//process_led();
//function update_butt(input_led1){
//  $("#input_led1").html("input_led1", "checked");
//}
...
function process_msg(topic, message){
  ...
  if (topic == "led1"){
    var msg = message.toString();
    if(msg == "on"){
      $('#process_input_led1').prop('checked',true); // lo activas
    }else{
      $('#process_input_led1').prop('checked',false); // lo desactivas
   }
 }
}
...
$('#input_led1').change(function(){
  if($('#input_led1').is(':ckecked')){
    var bott="";
    console.log(bott);
  }
});
...
function process_led(e){
  var input_id = e.id;//e.id hace referencia al id en input id="....." .../>
                      //por lo tanto la variable input_id toma el valor process_led1
  var separado = input_id.split("_");//separas la variabe input_id tomando como referencia el_
                                    //entonces es separado guarda process y led1 por separado..
                                    //proces se guarda en la posicion 0
                                    //led1 se guarda en la posicion 1
if($('#' + input_id).is(":checked")){
  console.log("Encendido");
  client.publish(separado[1],'on', (error) =>{ //valor de la posicion uno que era el led1
    console.log(error||"mensaje enviado!!!")
  });
}else{
  console.log("Apagado");
  client.publish(separado[1], 'off', (error) =>{
    console.log(error||"mensaje enviado!!!!")

  });
 }
}
//var val=document.getElementById("input_led1");
//$("input_led1[type=checkbox]").prop("checked", true)
  //console.log(input_led1);
//});
/*
******************************
****** CONEXION  *************
...
const WebSocket_URL = 'wss://matichouse.ml:8094/mqtt'
...
client.on('connect', () => {
    ...
    client.subscribe('led1/#', { qos: 0 }, (error) => {
      if (!error) {
        console.log('Suscripción exitosa!')
      }else{
        console.log('Suscripción fallida!')
    ...
    client.publish('fabrica', 'conectado desde atom', (error) => {
      console.log(error || 'Mensaje enviado!!!')
    })
})
